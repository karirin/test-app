...
?>
<!--search_inputに入っている値からユーザを検索している、function search_user($input)が関係しているか不明-->
...
<!--      // basename:指定のパスのフォルダ、ディレクトリの名前を取得、第二引数にtxtなど記載すると除去される

//$_SERVER['PHP_SELF']:現在のアドレス上のスクリプトのパスを指定。例、http://example.com/foo/bar.phpでは/foo/bar.phpとなる
-->
        <div class="show_prof">
