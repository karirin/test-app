...
<button class="btn modal_btn" data-target="#modal<?= $post['id'] ?>_wide" type="button" data-toggle="post" title="投稿"><i class="fas fa-comment-dots"></i></button>
<span class="post_comment_count"><?= current(get_post_comment_count($post['id'])) ?></span>
</div>
<div class="comment_confirmation" id="modal<?= $post['id'] ?>_wide">
...
<button class="btn modal_btn" data-target="#edit_modal<?= $post['id'] ?>_wide" type="button" data-toggle="edit" title="編集"><i class="fas fa-edit"></i></button>
<div class="post_edit" id="edit_modal<?= $post['id'] ?>_wide">
<p>投稿内容更新</p>
...
<button class="btn modal_btn" data-target="#delete_modal<?= $post['id'] ?>_wide" type="button" data-toggle="delete" title="削除"><i class="far fa-trash-alt"></i></button>
<div class="delete_confirmation" id="delete_modal<?= $post['id'] ?>_wide">
