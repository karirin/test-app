...
<div class="post narrower">
    ...
    <div class="post_info">
        ...
        <button class="btn modal_btn" data-target="#edit_modal<?= $post['id'] ?>_narrower" type="button"
        ...
        <button class="btn modal_btn" data-target="#delete_modal<?= $post['id'] ?>_narrower" type="button"
