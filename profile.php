...
<div class="slide_prof">
    ...
    <div class="profile">
        ...
        <button class="follow_btn border_white btn following" style="width: 10rem;margin-left: -0.8rem;" type="button"
            name="follow"><i class="fas fa-user-plus"></i><span id="follow_label">フォロー解除</span></button>
        <?php else : ?>
